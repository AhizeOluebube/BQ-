...
const QuestionBox = ({ title, question, askedBy, createdAt, image, _id }) => {
  ...
  return (
    ...
    >
      <div className="px-3 mb-3 ">
        <Link to={`/profile/ ${askedBy.username}`} className="d-flex gap-2">
          <Image
            src={askedBy.profilePhoto}
            alt={askedBy.username}
            style={{ width: "45px", height: "45px" }}
            roundedCircle
            className="object-fix-cover"
          />
